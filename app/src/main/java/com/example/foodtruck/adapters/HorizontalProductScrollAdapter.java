...
public class HorizontalProductScrollAdapter extends RecyclerView.Adapter<HorizontalProductScrollAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HorizontalProductScrollAdapter.ViewHolder holder, int position) {
        ...
        String productId = horizontalProductScrollModelList.get(position).getHorizontalProductId();
        holder.setProductData(productId , productImageUrl, productName, productDescription, productPrice);
    }
    ...
    public int getItemCount() {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            private void setProductData(final String productId , String  imageUrl, String name, String description, String price ) {

                Glide.with(itemView.getContext()).load(imageUrl).apply(new RequestOptions().placeholder(R.drawable.grid_placeholder)).into(productImage);
